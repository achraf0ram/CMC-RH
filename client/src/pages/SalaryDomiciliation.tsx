...
const SalaryDomiciliation: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      alert(language === 'ar' ? 'تم إرسال الطلب بنجاح!' : 'La demande a été envoyée avec succès !');
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-6 md:mb-8">
          <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent mb-2">
            {language === 'ar' ? 'طلب شهادة إقامة راتب غير قابلة للإلغاء' : "Demande d'attestation de domiciliation irrévocable de salaire"}
          </h1>
